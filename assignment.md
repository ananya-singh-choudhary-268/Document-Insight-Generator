# Assignment: AI-Powered Answer Sheet Grading Web App
...
The application should extract the questions from the paper, extract the student's answers, and display them side by side. When a teacher clicks on a question, the corresponding answer should be identified and the exact region of the answer sheet should be highlighted.

## Scope (Important)

This can include grading and AI-generated insights. The application **may** include:
...
A Figma design has been provided as a reference for the expected interface and overall experience. You are expected to follow the provided design closely while implementing the product.
...
Submit your completed assignment through the submission form. Please include:
